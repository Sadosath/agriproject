            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Ajouter une région</h6>
                ...
                if(isset($_POST['regions'])){ ;
                    ...
                    $sql = "SELECT * FROM regions WHERE NomR=:nomregion";
                    $req = $db->prepare($sql);
                    $req->execute($u);
                ...
                <form role="form" method="post" action="#">
                    <div class="col-sm-6 form-group">
                        ...
                        <input class="form-control" name="nomregion" type="" placeholder="" required>
                    </div>
                    <div class="col-sm-10 ml-sm-auto">
                        <button class="btn btn-primary" data-toggle="modal" name="regions" style="color : white" type="submit" OnClick="return confirm('Veuillez confirmer !!')">Ajouter</button>
                </form>
                <!-- End of Main Content -->
