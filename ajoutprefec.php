    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-2 text-gray-800">Préfectures</h1>

                <!-- DataTales Example -->
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Ajouter une préfecture</h6>
            ...
            <!-- /.container-fluid -->
                ...
                if(isset($_POST['prefectures'])){
                    ...
                    $sql = "SELECT * FROM prefectures WHERE NOM_PREFEC=:nomprefec ";
                    $req = $db->prepare($sql);
                    $req->execute($u);
                    $exist = $req->rowCount($sql);
                    if ($exist){
                        $erreur = "Cette préfecture existe déjà. Veuillez entrer une préfecture non existante !!! ";
                        echo  '<font color = "red">'.$erreur. "</font>";
                    }
                    else{

                        prefecture($idregion,$nomprefec);
                ...
                <form enctype="multipart/form-data" role="form" method="post" action="#">
                    <div class="col-sm-6 form-group">
                        <label>Nom de la région concernée</label>
                        <select name="idregion" class="form-control">
                            <?php
                            global $db;
                            $prefec = $db ->query("select * FROM regions");
                            while($prefe=$prefec->fetch()){
                                echo
                                    "<option value = ".$prefe['IdR'].">".$prefe['NomR']."</option>";
                            }
                            $prefec->closecursor();
                            ?>
                    ...
                    <div class="col-sm-6 form-group">
                        <label>Nom de la préfecture</label>
                        <input class="form-control" name="nomprefec" type="" placeholder="Nom de la préfecture" maxlength="25"required>
                    </div>
                    <div class="col-sm-10 ml-sm-auto">
                        <button class="btn btn-primary" data-toggle="modal" style="color : white" name="prefectures" type="submit" OnClick="return confirm('Veuillez confirmer !!')">Ajouter</button>
