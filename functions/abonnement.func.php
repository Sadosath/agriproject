...
function  utilisateur  ($nomutil,$prenomutil,$mail,$password)
{
    global $db;
    $r = array(
    ...
    $sql = "INSERT INTO utilisateur(NOM_UTIL,PREN_UTIL,MAIL,MOT_DE_PASSE ) VALUES(:nomutil,:prenomutil, :mail, :password)";
    $req = $db->prepare($sql);
    $req->execute($r);
}
