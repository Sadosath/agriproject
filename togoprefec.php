                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <img src ="planet.gif" width="145" height="126" alt"Planets" usemap="#planetmap">
                            <map mapname ="planetmap">
                                <area shape ="rect"
                                      coords="0,0,82,126" href="sun.htm" alt="sun">
                                <area shape ="circle" coords=90,58,3" href="mercure.htm" alt="Mercury">
