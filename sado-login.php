                    ...
                    <div class="p-5">
                      ...
                      if(isset($_POST['submit'])){
                        ...
                        if(admin_exist($num,$password) == 1){
                          ...
                          $_SESSION['nomadmin'] = $row['NOM_ADMIN'];
                          $_SESSION['prenomadmin'] = $row['PRENOM_ADMIN'];

                          ?>
                          <script > window.location.assign("prefecture.php");</script>

                        <?php
                        }elseif(admin_exist($num,$password)==0){
                            $error_user_not_found = "Login et/ou mot de passe incorrect";
                      ...
                      <form class="user" method="post">
                        ...
                        <div class="form-group">
                          <input type="" class="form-control form-control-user"  aria-describedby="emailHelp" name="num" id="num"  placeholder="Votre login " required>
                        </div>
                        <div class="form-group">
